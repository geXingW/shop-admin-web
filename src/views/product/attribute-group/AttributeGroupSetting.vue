  ...
  <div class="app-container">
    ...
    >
      <el-form
        ...
        label-width="80px"
      >
        <el-table :data="detachDialog.attributes" :visible.sync="detachDialog.show" align="center"
                  @selection-change="detachSelectChange"
        >
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '商品属性', url: 'api/product/attribute-group/attach-attribute',
  ...
  methods: {
    ...
    resetData(type, groupId) {
      this.crud.params.type = type
      this.crud.params.groupId = groupId
